...
List<Storyteller> storytellerFromJson(String str) => List<Storyteller>.from(
    json.decode(str).map((x) => Storyteller.fromJson(x)));

String storytellerToJson(List<Storyteller> data) =>
...
class Storyteller extends Equatable {
  ...
  factory Storyteller.fromJson(Map<String, dynamic> json) => Storyteller(
        ...
        pathPlaylist:
            json["pathPlaylist"] == null ? null : json["pathPlaylist"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "pathPlaylist": pathPlaylist == null ? null : pathPlaylist,
      };
